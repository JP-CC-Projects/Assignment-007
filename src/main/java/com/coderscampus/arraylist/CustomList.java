...
public interface CustomList<T> {
     ...
     * @throws IndexOutOfBoundsException when index is < 0 or > last index item
     */
    ...
    /**
     * This method should remove an item from the <code>CustomList</code> at the <p>
     * specified index. This will NOT leave an empty <code>null</code> where the item <p>
